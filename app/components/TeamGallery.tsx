            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogTitle className="text-xl font-semibold text-green-700 text-center">{member.name}</DialogTitle>
                  <DialogDescription className="text-sm font-medium text-green-600 text-center">{member.role}</DialogDescription>
                </DialogHeader>
